...
const CalendarApp = () => {
  const daysOfWeek = ["Sab", "Seg", "Ter", "Qua", "Qui", "Sex", "Dom"];
  const monthsOfYear = [
    "Janeiro",
    "Fevereiro",
    "Março",
  ...
  const handleTimeChange = (e) => {
    ...
    setEventText((prevTime) => ({...prevTime, [name]: value.padStart(2, '0')}))
  };
      ...
      <div className="events">
        {showEventPopup && (
          <div className="event-popup">
            ...
            <textarea
              placeholder="Digite um texto de evento (Máximo de 60 caracteres)"
              value={eventText}
              onChange={(e) => {
